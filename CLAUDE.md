...
1. **BEFORE DOING ANYTHING:**
   ...
   - Read [.agents/PROJECT_MAP.md](file:///.agents/PROJECT_MAP.md) — the single source of truth for domain ↔ codebase mapping (this repo contains ONLY TaskFlow; unknown project → ask the user).
