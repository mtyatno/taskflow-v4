// Pure UI components — extracted from index.html
// Dependencies: React (window global only)
// No dependencies on: api, tokenStore, AppContext, or any inline globals
...
function MentionInput({
  ...
  const handleChange = e => {
    ...
    if (atMatch && collaborators.length > 0) {
      ...
      const results = collaborators.filter(u => u.username.toLowerCase().startsWith(q) || (u.display_name || "").toLowerCase().startsWith(q) || q.length >= 2 && (u.username.toLowerCase().includes(q) || (u.display_name || "").toLowerCase().includes(q))).slice(0, 6);
      if (results.length > 0) {
        setMentionState({
          atPos,
          query: q
  ...
  const applyMention = user => {
    ...
    const nativeSetter = Object.getOwnPropertyDescriptor(Tag === "textarea" ? window.HTMLTextAreaElement.prototype : window.HTMLInputElement.prototype, "value")?.set;
  ...
  const handleKeyDown = e => {
    ...
    if (e.key === "ArrowDown") {
      ...
      if (filtered[highlighted]) {
        e.preventDefault();
        applyMention(filtered[highlighted]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onBlur: handleBlur,
    style: style
  }, Object.fromEntries(Object.entries(rest).filter(([k]) => !["onKeyDown", "onBlur"].includes(k))))), filtered.length > 0 && /*#__PURE__*/React.createElement("div", {
    ref: dropRef,
    style: {
      position: "absolute",
      top: "100%",
  ...
  }, filtered.map((u, i) => /*#__PURE__*/React.createElement("div", {
    key: u.id,
    onMouseDown: e => {
      e.preventDefault();
      applyMention(u);
  ...
  }, "@", u.username), u.display_name && u.display_name !== u.username && /*#__PURE__*/React.createElement("span", {
    style: {
...
const ICONS = {
  ...
  mindmap: '<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" x2="15.42" y1="13.51" y2="17.49"/><line x1="15.41" x2="8.59" y1="6.51" y2="10.49"/>',
  chat: '<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>',
  inbox: '<polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/>',
  next: '<path d="m6 17 5-5-5-5"/><path d="m13 17 5-5-5-5"/>',
...
function Icon({ name, size = 16, style, className }) {
  ...
  if (!inner) return /*#__PURE__*/React.createElement("span", null, name);
...
function NavIcon({ name }) {
  return /*#__PURE__*/React.createElement(Icon, { name: name, size: 18, style: { display: "block", verticalAlign: "baseline" } });
}
...
function ComboSelect({
  ...
  return /*#__PURE__*/React.createElement("select", {
    ...
    value: ""
  }, placeholder || "— Pilih —"), options.map(o => /*#__PURE__*/React.createElement("option", {
    key: o,
    value: o
  }, icon ? `${icon} ` : "", o)), /*#__PURE__*/React.createElement("option", {
    value: "__new__"
  }, "\uFF0B Tambah baru..."));
}
